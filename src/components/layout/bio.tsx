  ...
  return (
    ...
    >
      ...
      <Card className="md:w-1/3 p-3 mb-10 text-center">
        <p>
          Full-stack developer and UI-focused builder passionate about creating
          fast, modern, and user-friendly web applications. Skilled in{" "}
          <Link href="/#skills">The following</Link> and creative frontend
          experiences, with a strong interest in AI-powered tools and real-time
          systems. I enjoy turning ideas into clean, functional products that
          solve real problems.
        </p>
      </Card>
